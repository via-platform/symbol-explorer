...
module.exports = class SymbolExplorer {
    ...
    handleEvents(){
        this.disposables.add(via.markets.onDidUpdateCategories(this.didUpdateCategories.bind(this)));
        this.disposables.add(via.markets.onDidAddMarket(this.updateSymbols.bind(this)));
        this.disposables.add(via.markets.onDidRemoveMarket(this.updateSymbols.bind(this)));
    ...
    symbolViewEntryClicked(e){
        ...
        if(detail === 1){
            ...
            if(typeof symbol.openDefaultLocation === 'function'){
                ...
                via.workspace.open(`via://charts/${symbol.exchange.id}/${symbol.symbol}`, {});
            }
        }
    }
