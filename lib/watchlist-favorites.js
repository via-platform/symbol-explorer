...
module.exports = class WatchlistFavorites {
    ...
    getEntries(){
        let symbols = via.symbols.getSymbols().filter(symbol => this.watchlist.favorites.includes(symbol.identifier));
        ...
        for(let symbol of symbols){
            ...
            if(this.entries.has(symbol.identifier)){
                ...
                symbolsToDisplay.push(new WatchlistSymbol({isFavorite: true, symbol, path: symbol.identifier, watchlist: this.watchlist}));
            }
        }
